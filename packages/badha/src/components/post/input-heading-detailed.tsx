...
const DetailHeadingInput = ({ label, ...props }: OtherProps & FieldHookConfig<string>) => {
    ...
    <div className="w-full">
      ...
      <div className="mt-1 relative rounded-md shadow-sm">
        <Field
          ...
          className={`${classNames(...inputStyles)} h-16 leading-10 ${
        ...
        {/* {field.value.length > 0 && (
          <span className="inline-block px-2 py-1 text-xxs bg-gray-200 text-gray-700" id="email-optional">
            Heading
          </span>
        )} */}
...
export default DetailHeadingInput;
