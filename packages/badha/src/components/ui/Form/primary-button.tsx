...
const PrimaryButton: React.FC<any> = ({ label, ...props }) => {
  return (
    <button
      {...props}
      className={`${props.className} bg-red-next w-full text-white font-medium py-4 rounded-xl focus:shadow-button  focus:ring-offset-transparent focus:outline-none focus:border-red-next focus:border-opacity-20 focus:ring-red-next focus:ring-opacity-10  `}
