...
import { TAncestor, TDescendant } from "../types";

/**
 * Get the last child of a node or null if no children.
 */
export const getLastChild = (nodeEntry: NodeEntry<TAncestor>): NodeEntry<TDescendant> | null => {
 ...
 */
export const isLastChild = (parentEntry: NodeEntry<TAncestor>, childPath: Path): boolean => {
