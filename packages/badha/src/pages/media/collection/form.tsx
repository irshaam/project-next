...
//   const { tags, touched, errors } = props;
...
//         // const formData = {};
//         // client.post("/media/upload", formData, { header: {} });
...
//     nameEn: (collection && collection.nameEn) || "",
//     caption: (collection && collection.caption) || "",
//     captionEn: (collection && collection.captionEn) || "",
//     tags: (collection && collection.tags?.map((collection: { id: number }) => ({ id: collection?.id }))) || [],
//   }),
//   validationSchema,
...
const CreateMediaForm = (props: any) => {
  return <div>debuggin</div>;
};
